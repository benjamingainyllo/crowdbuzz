...
/**
 * Explore — every published event on CrowdBuzz, by city.
 *
...
export const metadata: Metadata = {
  ...
  description:
    "Every event selling on CrowdBuzz right now — parties, concerts, workshops, conferences and church programmes, city by city. Find one, get a ticket in a couple of taps.",
};
